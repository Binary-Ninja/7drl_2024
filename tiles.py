...
tile_replace: dict[TileID, TileID] = {
    ...
    TileID.CLOUD_BRICKS: TileID.CLOUD,
    TileID.CLOUD_FLOOR: TileID.CLOUD,
    TileID.CLOUD_DOOR_OPEN: TileID.CLOUD,
    TileID.CLOUD_DOOR_CLOSED: TileID.CLOUD,
    TileID.SKY_WINDOW: TileID.CLOUD,
    TileID.OBSIDIAN_DOOR_OPEN: TileID.DIRT,
    TileID.OBSIDIAN_DOOR_CLOSED: TileID.DIRT,
    TileID.COAL_ORE: TileID.DIRT,
}
...
tile_data = {
    ...
    TileID.OBSIDIAN_FLOOR: TileData("ob.floor", (Graphic.FLOOR3, Color.DARK_OBSIDIAN), 40, ),
    TileID.CLOUD_FLOOR: TileData("cl.floor", (Graphic.FLOOR4, Color.LIGHT_GRAY), 20, ),
    ...
    TileID.WINDOW: TileData("window", (Graphic.WINDOW, Color.LIGHT_BLUE), 2,
                            (TileTag.BLOCK_MOVE,)),
    TileID.SKY_WINDOW: TileData("skyglass", (Graphic.WINDOW, Color.LIGHT_GRAY), 4,
                            (TileTag.BLOCK_MOVE,)),
    ...
    TileID.OBSIDIAN_BRICKS: TileData("ob. wall", (Graphic.BRICKS, Color.OBSIDIAN), 40,
                                (TileTag.BLOCK_MOVE, TileTag.BLOCK_SIGHT)),
    TileID.CLOUD_BRICKS: TileData("cl. wall", (Graphic.BRICKS, Color.WHITE), 20,
                                     (TileTag.BLOCK_MOVE, TileTag.BLOCK_SIGHT)),
    ...
    TileID.CLOSED_WOOD_DOOR: TileData("wd. door", (Graphic.DOOR_CLOSED, Color.BROWN), 10,
                            (TileTag.BLOCK_MOVE, TileTag.BLOCK_SIGHT)),
    TileID.CLOUD_DOOR_OPEN: TileData("cl. door", (Graphic.DOOR_OPEN, Color.WHITE), 20, ),
    TileID.CLOUD_DOOR_CLOSED: TileData("cl. door", (Graphic.DOOR_CLOSED, Color.WHITE), 20,
                                      (TileTag.BLOCK_MOVE, TileTag.BLOCK_SIGHT)),
    TileID.OBSIDIAN_DOOR_OPEN: TileData("ob. door", (Graphic.DOOR_OPEN, Color.OBSIDIAN), 40, ),
    TileID.OBSIDIAN_DOOR_CLOSED: TileData("ob. door", (Graphic.DOOR_CLOSED, Color.OBSIDIAN), 40,
                                       (TileTag.BLOCK_MOVE, TileTag.BLOCK_SIGHT)),
    ...
    TileID.QUARTZ_ORE: TileData("quartz ore", (Graphic.ORE, Color.WHITE), 40,
                               (TileTag.BLOCK_MOVE, TileTag.BLOCK_SIGHT, TileTag.DAMAGE,)),
    TileID.COAL_ORE: TileData("coal ore", (Graphic.ORE, Color.DARK_GRAY), 10,
                                (TileTag.BLOCK_MOVE, TileTag.BLOCK_SIGHT, TileTag.DAMAGE,)),
